 ...
 * Use the [BarometricPressureDialogFragment.newInstance] factory method to
...
class BarometricPressureDialogFragment : DialogFragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment BarometricPressureDialogFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            BarometricPressureDialogFragment().apply {
